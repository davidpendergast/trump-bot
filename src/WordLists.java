...
public class WordLists {
    ...
    public static final List<String> NO_SURROUNDING_SPACES_PUNCTUATION = new ArrayList<String>();
    ...
    static {
        ...
        String[] noSpacePunctuation = {"--", "–"};
        Collections.addAll(NO_SURROUNDING_SPACES_PUNCTUATION, noSpacePunctuation);
        
        String[] midPunctuation = {",", "...", "-", ":", ";"};
        MIDSENTENCE_PUNCTUATION.addAll(NO_SURROUNDING_SPACES_PUNCTUATION);
